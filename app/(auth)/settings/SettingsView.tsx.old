...
export function SettingsView({ profile, userPlans, signOutAction }: SettingsViewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Profile Editor - Includes Account & Profile, Training Configuration, Coach Settings */}
      <ProfileEditor profile={profile} signOutAction={signOutAction} />

      {/* Section 3: Workout Plans */}
      <div className="space-y-3">
        <h2 className="text-lg font-semibold text-white">Workout Plans</h2>

        <CollapsibleCard icon={CalendarDays} title="My Training Plans">
          <div className="space-y-4 pt-4">
            <p className="text-sm text-gray-400">
              View and manage your generated workout plans
            </p>
            ...
            {userPlans.length > 0 && (
              <p className="text-xs text-gray-500">
                ⚠️ Deleting a plan permanently removes all workouts and logs
              </p>
            )}
          </div>
        </CollapsibleCard>
        ...
        <CollapsibleCard icon={FileText} title="Plan Generation Preferences">
          <div className="space-y-3 pt-4">
            <p className="text-sm text-gray-400">
              Customize how your AI coach generates workout plans
            </p>
      ...
      <div className="space-y-3">
        ...
        <CollapsibleCard icon={Download} title="Install App">
          <div className="space-y-4 pt-4">
            <p className="text-sm text-gray-400">
              Install FitCoach on your home screen for quick access and offline support
            </p>
            <button
