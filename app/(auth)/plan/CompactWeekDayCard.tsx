...
export function CompactWeekDayCard({
    ...
    return (
      <motion.div
        ...
        className={`
          ...
          ${isToday ? 'ring-2 ring-cyan-500/20' : ''}
        `}
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                {isToday && (
                  <span className="inline-flex items-center gap-1 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-2 py-0.5">
  ...
  const cardContent = (
    ...
    >
      ...
      {isToday && (
        <div className="absolute -right-1 -top-1 h-2 w-2 animate-pulse rounded-full bg-cyan-500 shadow-[0_0_6px_theme(colors.cyan.500)]" />
      )}
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          <div className={`
            ...
            ${isToday ? 'bg-cyan-500/20' : 'bg-gray-800/50'}
          `}>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          {status === 'completed' ? (
            ...
            <div className="flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-cyan-500 to-indigo-600 px-3 py-1.5">
